...
<img src="./images/640.png" alt="图片" style="zoom:67%;" align="left"/>
...
<img src="./images/641.png" alt="图片" style="zoom:67%;" align="left"/>
...
**（1）source 接口是具体资源访问策略的抽象，也是所有资源访问类所实现的接口。**



#### **（2）Resource 接口主要提供了如下几个方法:**
...
**（4）Spring 为 Resource 接口提供了如下实现类：**
...
（1）父类定义了骨架（调用哪些方法及顺序），某些特定方法由子类实现。

（2）最大的好处：代码复用，减少重复代码。除了子类要实现的特定方法，其他方法及方法调用顺序都在父类中预先写好了。
...
#### **4、采用模板方法模式是为了以一种统一而集中的方式来处理资源的获取和释放，以JdbcTempalte为例:**
